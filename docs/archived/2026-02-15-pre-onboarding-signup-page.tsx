// ============================================================================
// ARCHIVED — Pre-onboarding self-signup page
//
// Origin: tamtam-bot - vor self-signup/app/signup/page.tsx (Feb 15, 2026)
// Extracted 2026-05-31 before deleting the backup folder.
//
// Why kept: this was the FIRST self-serve signup flow before the onboarding
// wizard refactor. The current canonical tamtam-bot has no equivalent —
// signup now flows through /auth/callback after Stripe checkout or admin
// invite. If you ever want a "create company + trial without Stripe" UX
// again (the old "no credit card required" flow), this is the reference.
//
// Pattern: client-side Supabase signUp → server-side POST to /api/public/signup
// which creates company + keys + settings + billing trial atomically.
// The /api/public/signup endpoint may or may not still exist; check before
// reviving this UI.
// ============================================================================
